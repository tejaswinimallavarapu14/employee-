    ...
    return(
        <>
            ...
            <div className="navigationBar">
                ...
                <i className="fa fa-home" onClick={()=>{navigate("employeeDashboard/employeeHomePage")}}> Home</i>
            ...
            <div id="employeeGrid">
                <div id="employeeLinks">
                    <Link to={"employeeDashboard/personalDetails"} id="employeeSubLinks"><li>Personal Details</li></Link>
                    <Link to={"employeeDashboard/professionalDetails"} id="employeeSubLinks"><li>Professional Details</li></Link>
                    <Link to={"employeeDashboard/projectDetails"} id="employeeSubLinks"><li>Project Details</li></Link>
                    <Link to={"employeeDashboard/financeDetails"} id="employeeSubLinks"><li>Finance Details</li></Link>
                    <Link to={"employeeDashboard/viewPaySlip"} id="employeeSubLinks"><li>View PaySlip</li></Link>
                </div>
                <div id="employeeOutlet">
                    <Outlet></Outlet>
                </div>
            </div>
